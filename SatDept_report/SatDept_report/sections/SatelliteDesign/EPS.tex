...
\rowcolor[gray]{0.85} \textbf{Power management} &  &  \\
	...
	\hline
	   ~Gomspace NanoPower BP4 & \makecell{Mass of 176g \\ 9x configurable outputs \\ 6x inputs per module \\ EMI shielding \\ High temperature range} & \textbf{TO REQUEST!} \\
	\hline
\rowcolor[gray]{0.85} \textbf{Batteries} &  &  \\
	   ~Gomspace NanoPower BP4 & \makecell{Total capacity of 77Wh (2u) \\ Automatic heat regulation \\ Highly stackable \\ Mass of 270g (p.unit)} & \textbf{TO REQUEST!} \\
	\hline
...
\endfirsthead
	   ...
	   ~Power Management & Gomspace NanoPower P60 & \textbf{TO REQUEST!} &  \\
	\hline
