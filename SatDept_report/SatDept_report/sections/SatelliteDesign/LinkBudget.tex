...
\begin{figure}[h]
	...
	\centering
	\caption{Principal losses in the received signal \cite{linkBudget}}
...
Likewise, these losses can be due to ionospheric, tropospheric and other local effects. \cite{Link Budget}
...
scintillation effects, and those are the ones that will be treated in this dissertation. \cite{linkBudget}
\paragraph{Tropospheric Effects \cite{link Budget}}
...
\begin{figure}[h]
	...
	\centering
	\caption{Specific attenuation for different frequencies \cite{linkBudget}}
