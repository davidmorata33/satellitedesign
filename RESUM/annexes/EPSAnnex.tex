\subsubsection{EPS Scheme}

\paragraph{}How all the different electric systems are related is presented in the figure \ref

\begin{figure}[h]
\includegraphics[scale=0.6]{./annexes/images/epsbasics}
\centering
